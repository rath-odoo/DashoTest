...
import { putcourseenroll,putcourseenrollrequest, getuserbyId, deletedashboardcourses,deleteacourse } from '../AllAPICalls';
    ...
    try{
      await updateDoc(doc(storage, "dashoo", teacherUserId), {
        requestedList : arrayUnion({
          requester_firstname : props.userData.firstname,
          requester_lastname : props.userData.lastname,
          requester_username : props.userData.username,
          courseId : courseId ,
    ...
    const enrollHandler=(e)=>{
      ...
      putcourseenrollrequest({courseId, setEnrollStatus});
      {
        props.Course.teachers !== null && props.Course.teachers.map((teacher, index) => {
          let teacherUserId = teacher.username;
  ...
  return (
    <div className={classes.innerBox} >
      ...
      <div className={classes.para}>
        ...
        <div className={classes.enrollNow}>
	  {/*
