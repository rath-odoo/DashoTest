...
const ClassViewShort = (props) => {
  ...
  const viewClassDetailHandler = () => {
    history.push("/home/dashboard/classes/1");
    //props.setClassPath('/home/dashboard/classes/1');
  };
  ...
  const commentTime = ({ datetime }) => {
    ...
    let time =
      String(localTimeHour) + ":" + String(localTimeMin) + String(ampm);
        ...
        <div className={classes.leftInfo}>
          <div className={classes.classInfo}>
            <div className={classes.classData}>
              ...
              <div className={classes.time}>9:30 am -10:30 am</div>
		  ...
		  */}
          ...
          <div className={classes.topicsTitle}>
            <div className={classes.classNum}>#12</div>
            ...
            >
              {" >> "}
              Newtons Laws of Motion, paralellogram law, action and reaction
            </div>
          </div>
        </div>
