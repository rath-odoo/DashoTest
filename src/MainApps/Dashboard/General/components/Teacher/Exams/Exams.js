...
<img src={upcoming}  alt='upcoming' className={classes.upcoming} />
</div>
      ...
      {showWarning && (
        ...
        <div className={classes.warningBlock} style={{ borderColor }}>
            ...
            <div>
              ...
              <div className={classes.createExam}>Create a Exam</div>
            ...
            <option value="Examiner">Examiner</option>
              ...
              <div>
                ...
                <input className={classes.selectExaminerTwo} type="date" id="date" name="date" value={date.toISOString().slice(0, 10)} onChange={handleDateChange} />
              </div>
              </div>
