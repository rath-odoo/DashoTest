...
const CreateCourseForm=(props)=>{
   ...
   const initialFormDataSingleClass = Object.freeze({
	...
	courseIdsyllabusId: props.selectedCourse[0].id+"*"+props.selectedCourse[0].syllabus,
        serialNo: null,
        status: "scheduled",
        classdate: null,
    ...
    console.log("props.selectedCourse: ", props.selectedCourse[0].syllabus);
    ...
    const handleSubmit = (e) => {
	   ...
	   if(formDataSingleClass.duration===null){
          ...
          formDataSingleClass["courseId"] = formDataSingleClass.courseIdsyllabusId.split("*")[0];
   ...
   //Multi Class Details
    ...
    const showSyllabusTopicsHandler=()=>{
       ...
       {  formDataSingleClass.courseIdsyllabusId === null &&
 ...
 // )
  //);
   ...
   const result= props.selectedCourse
   

    console.log("selectedCourses: ", result);
   ...
   <div className={classes.createTicketForm}>
	  ...
	  */}
          ...
          <div className={classes.singleNMultiFormOption}>
              <button className={classes.singleClass} onClick={singleClassHandler} style={formButton1Style}> <h3> Single class</h3> </button>
              <button className={classes.multiClass} onClick={multiClassHandler} style={formButton2Style}> <h3> Multiple classes</h3> </button>
          </div>
	 ...
	 <form className={classes.formElement1} onSubmit={handleSubmit}>
	   ...
	   <div className={classes.firstFieldBlockLong}>
	             ...
	             <OptionFieldOneCourse requirement="*" 
	                        label="Choose course" 
           ...
           { showSyllabusTopics  && formDataSingleClass.courseIdsyllabusId !==null &&
                 <SyllabusTopics onPress={closeSyllabusTopicsHandler}
                                 syllabusId={formDataSingleClass.courseIdsyllabusId.split("*")[1]}
