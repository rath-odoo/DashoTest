...
import {OptionField,
	  DateField,
	  TimeField,DayField} from './FormInputObjects';
   ...
   */}
   ...
   <div className={classes.createTicketForm}>
	 ...
	 { props.selectedCourse !==null && props.selectedCourse.length > 0 &&
          ...
          { props.selectedCourse !==null && props.selectedCourse.length > 0 && showSingleClassForm &&  <form className={classes.formElement1} onSubmit={handleSubmit}>
		...
		/>
           ...
           {props.selectedCourse !==null && props.selectedCourse.length > 0 && !showSingleClassForm &&  <form className={classes.formElement1} onSubmit={handleSubmitMulti}>
