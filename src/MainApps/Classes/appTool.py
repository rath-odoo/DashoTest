...
mkfile1 = "cp ../AppCreationTools/basefiles/App2.js %s.js"%(App2)
os.system(mkfile1)
refile1="sed -i 's/App2/%s/g' %s.js"%(App2,App2)
os.system(refile1)


mkfile2 = "cp ../AppCreationTools/basefiles/TopInfoBarApp2.js TopInfoBar%s.js"%(App2) 
os.system(mkfile2)
...
rmparentapp="sed -i 's/messages/%s/g' TopInfoBar%s.js"%(parentapp,App2)
os.system(rmparentapp)


mkfile3 = "cp ../AppCreationTools/basefiles/App2ContentDiv.js %sContentDiv.js"%(App2)
os.system(mkfile3)
refile3="sed -i 's/App2/%s/g' %sContentDiv.js"%(App2,App2)
os.system(refile3)


mkfile4 = "cp ../AppCreationTools/basefiles/App2ContentDiv.module.css %sContentDiv.module.css"%(App2)
os.system(mkfile4)
...
mkfile1 = "cp ../AppCreationTools/basefiles/App2.js %s.js"%(App1)
os.system(mkfile1)
...
mkfile2 = "cp ../AppCreationTools/basefiles/TopInfoBarApp1.js TopInfoBar%s.js"%(App1)
os.system(mkfile2)
...
rmparentapp="sed -i 's/messages/%s/g' TopInfoBar%s.js"%(parentapp,App1)
os.system(rmparentapp)
...
mkfile3 = "cp ../AppCreationTools/basefiles/App2ContentDiv.js %sContentDiv.js"%(App1)
os.system(mkfile3)
refile3="sed -i 's/App2/%s/g' %sContentDiv.js"%(App1,App1)
os.system(refile3)

mkfile4 = "cp ../AppCreationTools/basefiles/App2ContentDiv.module.css %sContentDiv.module.css"%(App1)
os.system(mkfile4)
...
#Create app3 first
mkfile1 = "cp ../AppCreationTools/basefiles/App2.js %s.js"%(App3)
os.system(mkfile1)
refile1="sed -i 's/App2/%s/g' %s.js"%(App3,App3)
os.system(refile1)

mkfile2 = "cp ../AppCreationTools/basefiles/TopInfoBarApp3.js TopInfoBar%s.js"%(App3)
os.system(mkfile2)
...
rmparentapp="sed -i 's/messages/%s/g' TopInfoBar%s.js"%(parentapp,App3)
os.system(rmparentapp)



mkfile3 = "cp ../AppCreationTools/basefiles/App2ContentDiv.js %sContentDiv.js"%(App3)
os.system(mkfile3)
refile3="sed -i 's/App2/%s/g' %sContentDiv.js"%(App3,App3)
os.system(refile3)

mkfile4 = "cp ../AppCreationTools/basefiles/App2ContentDiv.module.css %sContentDiv.module.css"%(App3)
os.system(mkfile4)
