...
import Student from "./components/Teacher/AkshayStudent/Student";
...
const StudentsContentDiv = (props) => {
  ...
  const [generalOneMeetingMounted, setGeneralOneMeetingMounted] =
    useState(false);
  ...
  return (
    ...
    */}
        ...
        <Student userData={props.userData} rerender={props.rerender}   selectedCourse={props.selectedCourse}/>
      </div>
    </div>
  );
};
