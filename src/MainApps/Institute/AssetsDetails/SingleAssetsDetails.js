import classes from "./SingleAssetsDetails.module.css";
      ...
      <div className={classes.parentDiv}>
        <div className={classes.topBarHead}>
          <div className={classes.topHeadingDiv}>
            ...
            <div className={classes.discTitle}>Assets Name :</div>

            <div className={classes.topicTitle}>Dell Xps 13.3</div>
          </div>
        ...
        <div className={classes.middleSec}>
          <div className={classes.firstContainer}>
            <div className={classes.topContainer}>
              ...
              <div className={classes.mainHeading}>Assets Details</div>
            </div>
            ...
            <div className={classes.infoContainer3}>
              ...
              <div className={classes.subtitle3}>Inservice</div>
            </div>
          ...
          {/* <div className={classes.secondContainer}>
            <div className={classes.topContainer}>
              ...
              <div className={classes.mainHeading}>Price Details</div>
            </div>
        ...
        <div className={classes.descriptionDiv}>
          ...
          <div className={classes.descriptionTitle}>Assets Description : </div>
        </div>
...
export default SingleAssetsDetails;
