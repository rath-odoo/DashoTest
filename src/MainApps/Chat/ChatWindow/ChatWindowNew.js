...
function useMessages() {
  const [messages, setMessages] = useState([{'message':'none',"senderUserId":'1',"chatGroupId":'43'}]);
...
const ChatWindow = (props) =>{
    ...
    const commentGroupId = useMessages().chatGroupId;//Number(lastMessage[lastMessage.length - 1]);	
